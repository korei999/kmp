...
struct Alsa
{
    ...
    Alsa(const std::string_view device, u8 _channels, unsigned _periodTime, unsigned _sampleRate = g::sampleRate,
         unsigned _bufferTime = g::bufferTime, enum _snd_pcm_format _format = SND_PCM_FORMAT_S16_LE,
         snd_pcm_access_t _access = SND_PCM_ACCESS_RW_INTERLEAVED, int resample = 0)
        : channels {_channels},
    ...
    int SetChannels([[maybe_unused]] u8 _channels)
    {
        int err;
